...
export declare class NftService {
    ...
    private umi;
    constructor(configService: AppConfigService, mintAuthority: Keypair);
    ...
    getCollectionAuthorityRecordPda(collectionMint: PublicKey, authority: PublicKey): PublicKey;
}
export declare function createNftService(configService: AppConfigService, mintAuthority: Keypair): NftService;
